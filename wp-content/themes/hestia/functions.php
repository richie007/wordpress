...
function hestia_widgets_init() {
	...
	$sidebars_array = array(
		...
		'subscribe-widgets' => esc_html__( 'Subscribe Section', 'hestia' ),
		...
		'sidebar-top-bar' => esc_html__( 'Top Bar Sidebar', 'hestia' ),
		'header-sidebar' => esc_html__( 'Header Sidebar', 'hestia' ),
	);
